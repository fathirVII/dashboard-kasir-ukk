            ...
            <div>
                ...
                <select name="kategori" required
                    ...
                    <option value="handphone & aksesoris"
                        {{ $produk->kategori == 'handphone & aksesoris' ? 'selected' : '' }}>
                        Handphone & Aksesoris</option>
                    <option value="komputer & aksesoris"
                        {{ $produk->kategori == 'komputer & aksesoris' ? 'selected' : '' }}>
                        Komputer & Aksesoris</option>
                    <option value="audio visual" {{ $produk->kategori == 'audio visual' ? 'selected' : '' }}>Audio
                        Visual</option>
                    <option value="peralatan rumah tangga elektronik"
                        {{ $produk->kategori == 'peralatan rumah tangga elektronik' ? 'selected' : '' }}>
                        Peralatan Rumah Tangga Elektronik</option>
                </select>
            </div>
